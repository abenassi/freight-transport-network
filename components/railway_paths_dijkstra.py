...
class Network():
    ...
    def store_paths_in_excel(self, wb):
...
def calculate_paths_from_excel(wb, network_names=None):
    ...
    network.store_paths_in_excel(wb)
...
if __name__ == "__main__":
    ...
    # go to working directory with input files
    INPUT_DIR = r"C:\Dropbox\Proyectos\1. UBACyT 2011-2014 cargas\3. Matriz origen destino\2. Modelos\Matrices algoritmo dijkstra"
    old_dir = os.getcwd()
    os.chdir(INPUT_DIR)

    # load excel
    XL_INPUT = "Matriz de distancias OD - red ferroviaria.xlsx"
    wb = load_workbook(XL_INPUT)

    # main call
    calculate_paths_from_excel(wb)
